...
export const NavBar = () => {
    ...
    return (
        <header className='grid  z-50 fixed w-full bg-acento  gap-[2rem] '>
            {/* Overlay */}
            {isOpen && (
                <div
            ...
            <nav className='grid z-50 max-w-[1260px] bg-acento text-principal  m-auto md:flex p-4 relative grid-cols-2 gap-2.5 md:grid-cols-2 justify-between w-full items-center' >
